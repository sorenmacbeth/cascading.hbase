...
public class HBaseUtils {
    ...
    /**
     * creating a table with the given tabel name and the given
     * coulmnFamilyArray. if there is already a table with this name: 1. if the
     * table disabled => delete the table and create a new one 2. if the table
     * enabled =? check if the all the columns are there. if not => add the ones
     * that missing
     * 
     * @param tableName
     *            the table name
     * @param coulmnFamilyArray
     *            the coulmn family name
     * @return the htable
     * @throws IOException
     */
